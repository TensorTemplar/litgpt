...
def setup(
    ...
    precision: Optional[Literal["bf16-true", "bf16-mixed", "32-true"]] = "bf16-true",
    ...
    Arguments:
        ...
        access_token: Optional Huggingface hub token to access models with restrictions.
        cpu_offload: Whether to offload the optimizer and model parameters to the CPU to trade speed for lower VRAM usage.
    """
